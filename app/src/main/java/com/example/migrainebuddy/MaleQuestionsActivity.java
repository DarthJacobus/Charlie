...
public class MaleQuestionsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_male_questions);

        questionFlipper = findViewById(R.id.questionFlipperMale);
